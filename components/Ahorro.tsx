    ...
    <section style={{ padding: 'clamp(48px,7vw,88px) 0', background: '#f0f4fa' }}>
      <div className="container">
        <div style={{
          ...
          <p style={{ color: 'var(--color-primary)', fontWeight: 700, fontSize: 'var(--text-xs)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '16px' }}>Ahorro real</p>
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.75rem, 1.2rem + 2.5vw, 2.8rem)', fontWeight: 900, color: 'var(--color-text)', lineHeight: 1.15, letterSpacing: '-0.02em', marginBottom: '20px', maxWidth: '680px' }}>
            Hasta{' '}<span style={{ color: 'var(--color-primary)' }}>400€ menos al mes</span>{' '}que un alquiler tradicional
          </h2>
          <p style={{ fontSize: 'clamp(0.95rem, 0.85rem + 0.5vw, 1.15rem)', color: 'var(--color-text-muted)', lineHeight: 1.7, maxWidth: '520px', marginBottom: '32px' }}>
            En Coliving y Temporal, el precio incluye suministros, limpieza y mantenimiento. Sin comisiones ni sorpresas.
          </p>
          <Link
            href="/coliving"
