      ...
      <div className="container">
        <div style={{
          ...
          <h2 style={{
            ...
            fontSize: 'clamp(1.75rem, 1.2rem + 2.5vw, 2.6rem)',
            fontWeight: 900,
            color: 'var(--color-text)',
            lineHeight: 1.15,
            letterSpacing: '-0.02em',
            marginBottom: '20px',
          }}>Comunidad, también incluida</h2>
          ...
          <p style={{
            ...
            Conoce a otros profesionales, estudiantes y nómadas digitales.
            Organizamos eventos, grupos por afinidades y facilitamos que conectes desde el primer día.
          </p>
