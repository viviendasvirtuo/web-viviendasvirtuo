...
export const metadata: Metadata = {
  title: 'Alquiler Temporal para inquilinos — Viviendas Virtuo',
...
export default function InquilinosTemporalPage() {
  return (
    <>
      <Header />
      <main>
        ...
        <section style={{ padding: 'clamp(40px,6vw,80px) 0', background: 'var(--color-bg)' }}>
          <div className="container">
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Link href="/inquilinos/vacacional" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: VACACIONAL_ORANGE, color: 'white', borderRadius: 'var(--radius-lg)', padding: '12px 24px', textDecoration: 'none', fontWeight: 600, fontSize: 'var(--text-sm)' }}>Ver Alquiler Vacacional →</Link>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: 'clamp(60px,8vw,100px) 0', background: `linear-gradient(135deg, ${TEMPORAL_GREEN_DARK}, ${TEMPORAL_GREEN})`, textAlign: 'center' }}>
          <div className="container">
            ...
            <Link href="/contacto" style={{ display: 'inline-flex', alignItems: 'center', background: 'white', color: TEMPORAL_GREEN, fontWeight: 700, padding: '14px 32px', borderRadius: 'var(--radius-lg)', textDecoration: 'none', fontSize: 'var(--text-base)' }}>Consultar disponibilidad</Link>
          </div>
        </section>
      </main>
      <Footer />
