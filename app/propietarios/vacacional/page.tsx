            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
              {pasos.map((paso, i) => (
                <div key={paso.num} style={{ background: '#f8f9fc', borderRadius: 'var(--radius-xl)', border: '1px solid var(--color-border)', padding: '32px 28px', display: 'flex', flexDirection: 'column', gap: '16px', position: 'relative', overflow: 'hidden' }}>
                  ...
                  <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: i < 2 ? '#c45e00' : '#fff7ed', border: i < 2 ? 'none' : '2px solid rgba(196,94,0,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-sm)', color: i < 2 ? 'white' : '#c45e00' }}>{paso.num}</div>
