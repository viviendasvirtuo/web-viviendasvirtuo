        ...
        <section style={{ padding: 'clamp(60px,8vw,100px) 0', background: 'var(--color-bg)' }}>
          <div className="container">
            <div style={{ background: 'linear-gradient(135deg,#1a4a8a 0%,#0f2d5e 100%)', borderRadius: 'var(--radius-xl)', padding: 'clamp(40px,6vw,72px)', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', color: 'white' }}>
              ...
              <p style={{ fontSize: 'clamp(0.95rem,0.85rem + 0.5vw,1.1rem)', opacity: 0.85, lineHeight: 1.75, maxWidth: '520px', marginBottom: '36px' }}>Tu estancia temporal en Barcelona, 100% segura y sin costes sorpresa.
En un mercado lleno de incertidumbres, operamos bajo un marco legal estricto para ofrecerte flexibilidad real en estancias de media duración. Con nuestro modelo todo incluido, te garantizamos un contrato digital transparente, gestión ágil de fianzas y acceso a la "Wiki del piso" y el control total del piso en tu móvil tu móvil. Olvídate de sorpresas financieras: disfrutas de una habitación totalmente amueblada, suministros cubiertos y un único pago mensual sin complicaciones.</p>
