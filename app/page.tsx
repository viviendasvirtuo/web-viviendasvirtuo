    ...
    <>
      ...
      <main>
        ...
        <section id="que-ofrecemos" style={{ padding: 'clamp(60px,8vw,96px) 0', background: '#f0f4fa' }}>
          <div className="container">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px,1fr))', gap: '48px', alignItems: 'center' }}>
              <div>
                ...
                <Link href="/#todo-incluido" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#1a4a8a', color: 'white', fontWeight: 700, fontSize: 'var(--text-base)', padding: '13px 28px', borderRadius: 'var(--radius-lg)', textDecoration: 'none' }}>
                  Todo incluido
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" /></svg>
                </Link>
              </div>
          ...
          <style>{`.servicio-card{transition:transform .3s ease,box-shadow .3s ease}.servicio-card:hover{transform:scale(1.03);box-shadow:0 8px 24px rgba(0,0,0,.16)}`}</style>
        </section>
        ...
        <section style={{ padding: 'clamp(60px,8vw,100px) 0', backgroundImage: 'url(/images/habitacion-fondo.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="container">
            <div style={{ background: 'rgba(26,74,138,0.45)', borderRadius: 'var(--radius-xl)', padding: 'clamp(40px,6vw,72px)', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', color: 'white', backdropFilter: 'blur(8px)' }}>
              ...
              <p style={{ fontSize: 'clamp(0.95rem,0.85rem + 0.5vw,1.1rem)', opacity: 0.85, lineHeight: 1.75, maxWidth: '520px', marginBottom: '36px' }}>Tu estancia temporal en Barcelona, 100% segura y sin costes sorpresa. En un mercado lleno de incertidumbres, operamos bajo un marco legal estricto para ofrecerte flexibilidad real en estancias de media duración.<br />Con nuestro modelo todo incluido, te garantizamos un contrato digital transparente, gestión ágil de fianzas y acceso a la &quot;Wiki del piso&quot; con todo el control desde tu móvil.<br />Olvídate de sorpresas financieras: disfrutas de una habitación totalmente amueblada, suministros cubiertos y un único pago mensual sin complicaciones.</p>
        ...
        <section style={{ padding: 'clamp(60px,8vw,100px) 0', background: '#f0f4fa' }}>
          ...
          <style>{`
            .comunidad-grid{display:grid;grid-template-columns:1fr 1fr;gap:clamp(32px,5vw,64px);align-items:center}
            @media(max-width:768px){.comunidad-grid{grid-template-columns:1fr}.comunidad-imagen{order:1}.comunidad-texto{order:2;text-align:left}}
          `}</style>
        </section>
        ...
        <section style={{ padding: 'clamp(60px,8vw,100px) 0', background: 'var(--color-bg)' }}>
          <div className="container">
            ...
            {/* Grid horizontal de pasos + flechas entre ellos */}
            <div className="como-funciona-wrapper">
              ...
              {[
                ...
                <>
                  {/* Tarjeta de paso */}
                  <div key={s.paso} className="como-funciona-paso">
                    <div style={{
                  ...
                  {/* Flecha horizontal entre pasos (solo en desktop, oculta en móvil) */}
                  {i < arr.length - 1 && (
                    <div key={`arrow-${i}`} className="como-funciona-flecha" aria-hidden="true">
                      <svg width="48" height="32" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M 4 16 C 16 4, 32 28, 44 16" stroke="var(--color-primary)" strokeWidth="2.5" strokeLinecap="round" fill="none" opacity="0.45" />
                        <path d="M 38 10 L 44 16 L 38 22" stroke="var(--color-primary)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.45" />
                      </svg>
                    </div>
                  )}
                </>
